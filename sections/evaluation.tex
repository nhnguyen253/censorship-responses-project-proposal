...
app-store censorship. We evaluate along three axes.
...
\end{itemize}
We will quantify how cleanly these heuristics separate our sensitive basket from
the controls, and we will be explicit in the writeup about what the data can and
cannot establish. This honest treatment of attribution is itself a contribution,
since it directly addresses a known weakness of availability-based censorship
measurement.
